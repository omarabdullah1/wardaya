...
/// @nodoc
abstract class _$$CountryCodeImplCopyWith<T, $Res> {
  factory _$$CountryCodeImplCopyWith(_$CountryCodeImpl<T> value,
          $Res Function(_$CountryCodeImpl<T>) then) =
      __$$CountryCodeImplCopyWithImpl<T, $Res>;
  @useResult
  $Res call({String countryCode});
}

/// @nodoc
class __$$CountryCodeImplCopyWithImpl<T, $Res>
    extends _$RegisterStateCopyWithImpl<T, $Res, _$CountryCodeImpl<T>>
    implements _$$CountryCodeImplCopyWith<T, $Res> {
  __$$CountryCodeImplCopyWithImpl(
      _$CountryCodeImpl<T> _value, $Res Function(_$CountryCodeImpl<T>) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$CountryCodeImpl<T>(
      null == countryCode
          ? _value.countryCode
...
class _$CountryCodeImpl<T> implements CountryCode<T> {
  const _$CountryCodeImpl(this.countryCode);
  ...
  @override
  String toString() {
    return 'RegisterState<$T>.setCountryCode(countryCode: $countryCode)';
  }
  ...
  _$$CountryCodeImplCopyWith<T, _$CountryCodeImpl<T>> get copyWith =>
      __$$CountryCodeImplCopyWithImpl<T, _$CountryCodeImpl<T>>(
          this, _$identity);
...
abstract class CountryCode<T> implements RegisterState<T> {
  const factory CountryCode(final String countryCode) = _$CountryCodeImpl<T>;
