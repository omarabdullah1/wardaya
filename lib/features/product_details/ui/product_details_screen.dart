...
class _ProductDetailsScreenState extends State<ProductDetailsScreen> {
  ...
  void initState() {
    super.initState();
    // We will load favorites in the build method using BlocProvider
  }
                                  ...
                                  Row(
                                    children: [
                                      ...
                                      Text.rich(
                                        TextSpan(
                                          text:
                                              '${context.el.earn} ${product.points} \n',
                                          style: GoogleFonts.inter(
                                            fontSize: 15.0.sp,
                                            fontWeight: FontWeight.w700,
                                          ),
...
class ProductDetailsAppBar extends StatelessWidget
  ...
  Widget build(BuildContext context) {
    final Product product =
        (context.findAncestorWidgetOfExactType<ProductDetailsScreen>()
                as ProductDetailsScreen)
            .product;
