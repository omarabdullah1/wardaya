...
part of 'add_favorites_response.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

AddFavoritesResponse _$AddFavoritesResponseFromJson(
        Map<String, dynamic> json) =>
    AddFavoritesResponse(
      message: json['message'] as String?,
      favorites: (json['favorites'] as List<dynamic>?)
          ?.map((e) => AddFavoriteProduct.fromJson(e as Map<String, dynamic>))
          .toList(),
    );

Map<String, dynamic> _$AddFavoritesResponseToJson(
        AddFavoritesResponse instance) =>
    <String, dynamic>{
      'message': instance.message,
      'favorites': instance.favorites,
    };

AddFavoriteProduct _$AddFavoriteProductFromJson(Map<String, dynamic> json) =>
    AddFavoriteProduct(
...
Map<String, dynamic> _$AddFavoriteProductToJson(AddFavoriteProduct instance) =>
    <String, dynamic>{
