...
class _$SuccessImpl implements Success {
  const _$SuccessImpl({required final List<Address> addresses})
...
abstract class Success implements AddressState {
  const factory Success({required final List<Address> addresses}) =
      _$SuccessImpl;
