            ...
            return Padding(
              ...
              child: Container(
                decoration: BoxDecoration(
                  ...
                  border: Border.all(
                    color: option == cubit.selectedDate
                ...
                child: RadioTheme(
                  ...
                  child: RadioListTile<String>(
                    title: SizedBox(
                      ...
                      child: Row(
                        children: [
                              ...
                              children: [
                                Row(
                                  ...
                                  children: [
                                    Flexible(
                                      child: Text(
                                        option == context.el.selectOtherDate
                                            ? (cubit.selectedDate ??
                                                context.el.selectOtherDate)
                                            : option,
                                        style: option == cubit.selectedDate
                          ...
                          const HorizontalSpace(width: 10),
                          if (option == context.el.selectOtherDate)
                            IconButton(
                              onPressed: () async {
                    ...
                    value: option,
                    groupValue: cubit.selectedDate,
                    onChanged: (value) async {
                      if (option == cubit.selectedDate) {
                        final DateTime? picked = await showDatePicker(
                          context: context,
                          initialDate: DateTime.now(),
                          firstDate: DateTime(2025),
                                  ...
                                  children: [
                                    ...
                                    if (optionsOffValue.isNullOrEmpty())
                                      ...
                                      Container(
                                        ...
                                        child: Text(
                                          "${optionsOffValue![options.indexOf(option)]}% ${context.el.off}",
                                          style:
