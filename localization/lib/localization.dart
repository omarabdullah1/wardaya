...
class LocalizationMessages {
  ...
  factory LocalizationMessages.fromJson(Map<String, dynamic> json) {
    return LocalizationMessages(
      ...
      validationEmailPasswordRequired:
          (json['validation_email_password_required'] ?? '').toString(),
      ...
      passwordResetLinkSent:
          (json['password_reset_link_sent'] ?? '').toString(),
      ...
      addressSavedSuccessfully:
          (json['address_saved_successfully'] ?? '').toString(),
      addressUpdatedSuccessfully:
          (json['address_updated_successfully'] ?? '').toString(),
      addressDeletedSuccessfully:
          (json['address_deleted_successfully'] ?? '').toString(),
      ...
      defaultAddressWithArea:
          (json['default_address_with_area'] ?? '').toString(),
      addressLabelHint: (json['address_label_hint'] ?? '').toString(),
      extraAddressLabelHint:
          (json['extra_address_label_hint'] ?? '').toString(),
      ...
      subscriptionCheckoutTitle:
          (json['subscription_checkout_title'] ?? '').toString(),
      ...
      proceedToPaymentButton1:
          (json['proceed_to_payment_button'] ?? '').toString(),
      ...
      askRecipientForAddress:
          (json['ask_recipient_for_address'] ?? '').toString(),
      ...
      firstDeliveryPaymentDetails:
          (json['first_delivery_payment_details'] ?? '').toString(),
      ...
      totalVatIncludedLabel:
          (json['total_vat_included_label'] ?? '').toString(),
      ...
      dragMapToAdjustLocation:
          (json['dragMapToAdjustLocation'] ?? '').toString(),
      selectedLocation: (json['selectedLocation'] ?? '').toString(),
      confirmLocation: (json['confirmLocation'] ?? '').toString(),
      locationServicesDisabled:
          (json['locationServicesDisabled'] ?? '').toString(),
      locationPermissionsDenied:
          (json['locationPermissionsDenied'] ?? '').toString(),
      locationPermissionsPermanentlyDenied:
          (json['locationPermissionsPermanentlyDenied'] ?? '').toString(),
      currentLocationPinned: (json['currentLocationPinned'] ?? '').toString(),
      couldNotGetCurrentLocation:
          (json['couldNotGetCurrentLocation'] ?? '').toString(),
  ...
  Map<String, Object> get _content => {
        ...
        r'''validation_email_password_required''':
            validationEmailPasswordRequired,
        ...
        r'''locationPermissionsPermanentlyDenied''':
            locationPermissionsPermanentlyDenied,
...
Enjoy the magic of regular fresh flower deliveries that transofrm your space, uplift your spirit, and spread joy all y...''',
  ...
  locationPermissionsDenied:
      'Location permissions denied. Please grant permission to use your location.',
  locationPermissionsPermanentlyDenied:
...
استمتع بسحر توصيل الزهور الطازجة المنتظمة التي تعمل على تحويل مساحتك، ورفع روحك، ونشر الفرح طوال الوقت''',
  ...
  locationPermissionsDenied:
      'تم رفض أذونات الموقع. يرجى منح الإذن لاستخدام موقعك.',
  locationPermissionsPermanentlyDenied:
